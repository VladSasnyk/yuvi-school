...
const InfoSection = ({ experience, students, level, about, changeHandler, name }) => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 shadow-lg text-center text-lg p-4 max-md:pb-12 max-sm:text-base' id="infoSection">
      ...
      <h2 className='w-full bg-[#c14649] text-white text-4xl text-center p-2 max-sm:text-2xl'>{name}</h2>
      ...
      <Button className='text-[#c14649] w-1/3 max-md:w-1/2 max-sm:w-2/3 max-sm:text-sm py-2' onClick={changeHandler.bind(null, true)}>ВІДГУКИ</Button>
