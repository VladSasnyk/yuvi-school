        ...
        <section id='teachers' className='opacity-0 flex-col gap-14 h-auto pt-10' ref={ref}>
            ...
            <div className='text-center flex gap-8 max-md:flex-col' id='teachersButtons'>
                <Button
                    ...
                    className={`py-3 text-xl max-sm:text-lg ${filterTeachers === 'adults' ? 'bg-transparent  ' : 'border-2  border-[#c14649] text-[#c14649]'}`} id='buttonFilterLeft'>
                    Викладачі для дітей 6-12 років
                </Button>
                <Button
                    onClick={() => filterHandler('adults')}
                    className={`py-3 text-xl max-sm:text-lg ${filterTeachers === 'children' ? 'bg-transparent ' : 'border-2 border-[#c14649] text-[#c14649]'}`} id='buttonFilterRight'>
            ...
            <a href='https://www.canva.com/design/DAF9U9wkJS4/9f4E620yZL896dmZK0WsUg/view' target='_blanc'>
                <Button className='text-[#c14649] text-xl absolute z-10 left-[40vw] min-w-[20vw] max-md:min-w-[60vw] max-md:left-[20vw] py-2'>Вільні години</Button>
            </a>
            {selectedImage && (
