...
const ModalOverlay = (props) => {
    return <div className="h-auto fixed top-[11vh] left-[20%] w-[60%] bg-[#E2E1DD] p-6 text-black rounded-xl shadow-md z-30 slide-down max-sm:top-[5vh] max-[375px]:top-0 max-lg:w-[90%] max-lg:left-[5%]">
